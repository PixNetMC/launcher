...
class Home {
        ...
        if (news) {
            ...
            blockNews.innerHTML = `
                <div class="news-header">
                        ...
                        <div class="date">
                            <div class="day">Unknown Day</div>
                            <div class="month">Unknown Month</div>
                        </div>
                    </div>
                    <div class="news-content">
                        <div class="bbWrapper">
                            <p>Unable to connect to the news server. <b>Please check your internet connection.</b></p>
                        </div>
                    </div>`
            newsElement.appendChild(blockNews);
        }
    ...
    async instancesSelect() {
        ...
        let instanceBTN = document.querySelector('.instance')
        ...
        instanceBTN.addEventListener('click', async e => {
            ...
            if (e.target.classList.contains('dwnload-btn')) {
    ...
    async startGame() {
        ...
        launch.on('check', (progress, size) => {
            infoStarting.innerHTML = `Verifying: ${((progress / size) * 100).toFixed(0)}%`
            ipcRenderer.send('main-window-progress', { progress, size })
            progressBar.value = progress;
            progressBar.max = size;
        });
        ...
        launch.on('data', (e) => {
            ...
            ipcRenderer.send('main-window-progress-load')
            infoStarting.innerHTML = `Game is Running...`
            console.log(e);
        })
        ...
        launch.on('close', code => {
            ...
            infoStarting.innerHTML = `Verifying`
