...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Reacting to Stimuli...", "author": "COHEJH" },
            { "message": "Hello There!", "author": "Obi-Wan Kenobi" },
            { "message": "I am a Teapot", "author": "COHEJH" },
            { "message": "Mmmmhmmmm", "author": "Will" },
            { "message": "You shall not Pass!!!", "author": "Gandalf" },
            { "message": "Get out o' my swamp!", "author": "Shrek" }
        ];
